		...
		const delay = setInterval( async () => {
			try{
				...
				if (race.status === "in-progress"){
					renderAt('#leaderBoard', raceProgress(rece.positions))
				}
				else if (race.status === "finished"){
					clearInterval(delay) // to stop the interval from repeating
					renderAt('#race', resultsView(rece.positions)) // to render the results view
...
function changeRacerName(name) {
	let newName; 

	if (name === "Racer 1"){
		newName = "Anakin Skywalker";
	}
	else if (name === "Racer 2"){
		newName = "Dud Bolt"
	}
	else if (name === "Racer 3"){
		newName = "Ratts Tyrell"
	}
	else if (name === "Racer 4"){
		newName = "Ben Quadrinaros"
	}
	else {
		newName = "Sebulba"
	}
...
function changeTrackName(name){
	...
	if (name === "Track 1"){
		...
		newName = "Sebulba's Legacy"
	}
	else if (name === "Track 3"){
		newName = "Grabvine Gateway"
	}
	else if (name === "Track 4"){
		newName = "Andobi Mountain Run"
	}
	else if (name === "Track 5"){
		newName = "Dethro's Revenge"
	}
	else {
		newName = "The Boonda Classic"
	}
